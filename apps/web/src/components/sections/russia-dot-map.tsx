...
const cities = [
  { name: "РњРѕСЃРєРІР°", x: 18, y: 52 },
  { name: "РЎРџР±", x: 14, y: 38 },
  { name: "РљР°Р·Р°РЅСЊ", x: 28, y: 48 },
  { name: "Р•РєР±", x: 38, y: 50 },
  { name: "РќРѕРІРѕСЃРёР±РёСЂСЃРє", x: 58, y: 52 },
  { name: "РљСЂР°СЃРЅРѕРґР°СЂ", x: 22, y: 62 },
  { name: "РЎРѕС‡Рё", x: 20, y: 68 },
  { name: "Р’Р»Р°РґРёРІРѕСЃС‚РѕРє", x: 88, y: 58 },
];
